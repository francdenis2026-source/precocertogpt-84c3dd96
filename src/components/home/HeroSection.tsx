...
export function HeroSection({ products, loading, productCount, storeCount, priceCount }: { products: Product[]; loading: boolean; productCount: number; storeCount: number; priceCount: number }) {
  return <section className="pc26-hero">
    <div className="pc26-hero__art" aria-hidden="true"><img src="/economy-hero-2026.svg?v=20260826-visible" alt="" decoding="async" fetchPriority="high" /></div>
    <div className="pc26-shell pc26-hero__grid">

...
export function ProductGrid({ products, loading }: { products: Product[]; loading: boolean }) {
  return <section className="pc26-products pc26-shell" aria-labelledby="offers-title">

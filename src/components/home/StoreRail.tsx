...
export function StoreRail({ stores }: { stores: StoreRow[] }) {
  ...
  return <section className="pc26-stores pc26-shell" aria-labelledby="stores-title">
    <div className="pc26-section-heading">
      <div><span className="pc26-section-kicker">Comércio local</span><h2 id="stores-title">Estabelecimentos em destaque</h2><p>Consulte o catálogo e os preços de cada loja.</p></div>

  ...
  return <header className="pc26-header">
    <div className="pc26-shell pc26-header__row pc26-header__primary">
      ...
      <div className="pc26-actions" aria-label="Ações rápidas">
        ...
        <button className="pc26-header-action pc26-menu" type="button" onClick={() => setMenuOpen(value => !value)} aria-expanded={menuOpen} aria-controls="pc26-navigation" aria-label={menuOpen ? "Fechar menu" : "Abrir menu"}><Menu aria-hidden="true" /></button>
      </div>
    </div>

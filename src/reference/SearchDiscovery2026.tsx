...
export function SearchDiscovery2026(){
 ...
 return <div className="search26-page" ref={pageRef}><PublicHeader current="search" /><main id="conteudo-principal" className="search26-shell search26-main">
  <section className="search26-hero"><div><span><Search/> BUSCA INTELIGENTE LOCAL</span><h1>Procure só o que você precisa.</h1><p>Digite um produto, marca ou loja e compare o menor preço em segundos.</p></div><aside><BadgeCheck/><strong>{catalog?.metrics.products||0} produtos</strong><small>disponíveis para consulta</small></aside></section>
